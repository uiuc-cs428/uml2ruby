...
#TUXML_OUTPUT_FILE=testRandomVariableAssignment.xml ruby acceleo/testing/random_variable_assignment/ruby_unit/random_variable_assignment_test.rb --runner xml
