...
TUXML_OUTPUT_FILE=testAssociationClass.xml ruby acceleo/testing/class_association_class/ruby_unit/class_association_class_test.rb --runner xml
...
TUXML_OUTPUT_FILE=testRandomVariableAssignment.xml ruby acceleo/testing/random_variable_assignment/ruby_unit/random_variable_assignment_unit_test.rb --runner xml
